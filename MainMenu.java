...
public class MainMenu {
    ...
    static void displayInfoPage() {
        ...
        System.out.println("#                                                                                               #");
        System.out.printf("#   %-92s","First Name: " + user.fName);
        System.out.println("#");
        System.out.printf("#   %-92s","Middle Name: "+ user.mName);
        System.out.println("#");
        System.out.printf("#   %-92s","Last Name: " + user.lName);
        System.out.println("#");
        System.out.printf("#   %-92s","Age: " + user.age);
        System.out.println("#");
        ...
        for(int i = 0; i < user.emails.length; i++) {
            if(user.emails[i].equals("n/a")){
                ...
                System.out.printf("#   %-92s","Email: " + user.age);
                System.out.println("#");
            }
        }
